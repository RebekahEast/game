...
let whatHappens3 =
  "when right is pressed I want to move all 2s to the right - this doesn't do all just the top row";
let whatHappens4 =
  "when left is pressed I want to move all 2s to the left - this doesn't do all just the top row";
